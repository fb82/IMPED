...
if __name__ == '__main__':   
    ...
    tth_to_csv(tth, csv_file='../../fb_IMC/kaggle_raw_data/thresholds.csv')
    ...
    if not already_run:
        make_input_data(csv_gt='../../fb_IMC/kaggle_raw_data/gt.csv', input_folder='../../fb_IMC/kaggle_raw_data',
                        ...
                        mapping_csv='../../fb_IMC/kaggle_data/mapping.csv', final_gt_csv='../../fb_IMC/kaggle_data/gt.csv',
                        final_tth='../../fb_IMC/kaggle_data/thresholds.csv', obfuscate_data=False)
    ...
    # remaining images are put in the outlier cluster
    submission = make_todo(img_file='../../fb_IMC/kaggle_data', rec_file='../../fb_IMC/kaggle_submission')
    to_csv(submission, csv_file='../../fb_IMC/kaggle_submission/submission.csv')    
