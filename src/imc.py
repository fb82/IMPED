...
if __name__ == '__main__':   
    ...
    score_all_ext('../data/imc2025/kaggle_data/gt.csv', '../data/imc2025/kaggle_submission/submission.csv', thresholds='../data/imc2025/kaggle_data/thresholds.csv', per_th=False, strict_cluster=False)
